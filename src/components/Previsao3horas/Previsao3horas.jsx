...
function Previsao3Horas({ horas }) {
  ...
  return (
    <Box
      ...
      mb={4}
      w="100%"
      maxW={{ base: "100%", lg: "897px" }}
      boxShadow="dark-lg"
    >
      {/* Título */}
      <Text
        fontSize={{ lg: "15px", sm: "sm", base: "xs", md: "md" }}
      ...
      >
        {horas.map((item, index) => (
          ...
          >
            {/* Hora */}
            <Text fontSize={{ lg: "18px", sm: "sm", base: "xs" }} mb={6}>
              {item.hora}
            </Text>
            ...
            <Image
              src={
                iconesClima[item.icon] ||
                `https://openweathermap.org/img/wn/${item.icon}@2x.png`
              }
              alt="Ícone clima"
              boxSize={{ lg: "56px", base: "32px", md: "40px", sm: "36px" }}
              mb={6}
            />
            ...
            <Text
              ...
              fontSize={{ lg: "18px", base: "sm", md: "md" }}
            >
              {item.temp}°
            </Text>
